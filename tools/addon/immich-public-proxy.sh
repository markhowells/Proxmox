...
source <(curl -fsSL https://raw.githubusercontent.com/markhowells/Proxmox/main/misc/core.func)
source <(curl -fsSL https://raw.githubusercontent.com/markhowells/Proxmox/main/misc/tools.func)
source <(curl -fsSL https://raw.githubusercontent.com/markhowells/Proxmox/main/misc/error_handler.func)
source <(curl -fsSL https://raw.githubusercontent.com/markhowells/Proxmox/main/misc/api.func) 2>/dev/null || true
...
type=update bash -c "$(curl -fsSL https://raw.githubusercontent.com/markhowells/Proxmox/main/tools/addon/immich-public-proxy.sh)"
UPDATEEOF
